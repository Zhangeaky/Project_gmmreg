...
# /media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/VXLConfig.cmake
#
...
set(VXL_LIBRARY_DIR "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/lib")

# The VXL CMake support directory.
# Clients projects should not use the Find*.cmake files in this directory.
set(VXL_CMAKE_DIR "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/config/cmake/Modules")

# Doxygen Support
set(VXL_CMAKE_DOXYGEN_DIR "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/config/cmake/doxygen")
...
set(VXL_VCL_INCLUDE_DIRS "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/vcl;/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/vcl")
set(VXL_VCL_INCLUDE_DIR "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/vcl") #For backward compatibility
set(VXL_VCL_LIBRARIES "vcl")

set(VXL_CORE_FOUND "YES" ) # VXL core is always FOUND.  It is not optional.
set(VXL_CORE_INCLUDE_DIRS "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/core;/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/core")
set(VXL_CORE_INCLUDE_DIR "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/core") #For backward compatibility
# VXL core has many libraries

set(VXL_CORE_VIDEO_FOUND "OFF" )
set(VXL_CORE_VIDEO_INCLUDE_DIRS "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/core;/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/core")
set(VXL_CORE_VIDEO_INCLUDE_DIR "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/core") #For backward compatibility
...
set(VXL_NETLIB_INCLUDE_DIR "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/v3p/netlib")
...
set(VXL_GEOTIFF_INCLUDE_DIR "/media/agent/data2/zhangeaky/gmmreg/Cpp/vxl-2.0.2/v3p/geotiff")
