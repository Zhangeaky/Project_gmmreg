...
#cmake conformant style is to use _DIRS instead of _DIR
set(VXL_VCL_INCLUDE_DIRS "/usr/local/include/vxl/vcl")
set(VXL_VCL_INCLUDE_DIR "/usr/local/include/vxl/vcl") #For backward compatibility
set(VXL_VCL_LIBRARIES "vcl")

set(VXL_CORE_FOUND "YES" ) # VXL core is always FOUND.  It is not optional.
#cmake conformant style is to use _DIRS instead of _DIR
set(VXL_CORE_INCLUDE_DIRS "/usr/local/include/vxl/core")
set(VXL_CORE_INCLUDE_DIR "/usr/local/include/vxl/core") #For backward compatibility
